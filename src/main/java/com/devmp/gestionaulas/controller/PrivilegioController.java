...
import com.devmp.gestionaulas.service.PrivilegioService;
...
public class PrivilegioController {
	...
	public ResponseEntity<?> guardar(@RequestBody Privilegio materia) {
		Privilegio res = service.insertOrUpdate(materia);
		if (res != null) {
